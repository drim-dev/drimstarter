...
namespace Drimstarter.Common.Web.Errors;

public static class ErrorsWebApplicationExtensions
{
    public static WebApplication MapProblemDetails(this WebApplication app)
    {
